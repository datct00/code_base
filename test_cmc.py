    ...
    for epoch in range(max_epoch):
        ...
        with tqdm(total=labeled_slice, desc=f'Epoch {epoch + 1}/{max_epoch}', unit='img', leave=is_leave) as pbar:
            for i,batch in enumerate(train_loader):
                ...
                #For CMC
                _,_, masks_pred_mode1_sup, masks_pred_mode2_sup = cmc_net.forward_CMC(imgs_mode1[:labeled_bs], imgs_mode2[:labeled_bs])
...
def set_argparse():
    ...
    parser.add_argument('--base_dir', type=str,default='res-without_CSC_CAC_BraTs-seed-2-CMC-10%_seed_1111_2nd', 
                        help='base dir name')
