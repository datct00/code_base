                ...
                #epoch 52
                    ...
                    for i in range(T):
                        ...
                        with torch.no_grad():
                            ...
                            _,_,_, preds_mode_2[i] = cmc_net_bma.forward_bma_only_mode_2(noise_inputs_un_mode_2)
...
def set_argparse():
    ...
    parser.add_argument('--base_dir', type=str,default='res-CML_MIA_BraTs-seed-2-CMC-10%_seed_1111', 
                        help='base dir name')
