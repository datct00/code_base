...
def train_net(start_time,base_dir,data_path,train_list,val_list,device,img_mode='',
    ...
    unlabled_bs = batch_size-labeled_bs
                                                           #dice       #set_false
    contrast_loss = ASC_loss(unlabled_bs, device, sur_siml, pHead_sur)
    ...
    return train_log.res_dict,val_log.res_dict,lr_curve,net_mode1,net_mode2
...
def main():
    ...
    global img_h,img_w
    if img_mode=='ct_pet':
        data_path = "./dataset/Hecktor_slice" 
        img_h,img_w = 144,144
    else:
        data_path = "./dataset/BraTS_slice" 
        img_h,img_w = 160,160
...
def set_argparse():
    ...
    parser.add_argument('--base_dir', type=str,default='res-BraTs-seed-4-Semi-CML-1%_seed_1111', 
                        help='base dir name')
    ...
    parser.add_argument('--root_folders', type=str)
    parser.add_argument('--ram_ft_path', type=str)
    ...
    parser.add_argument('--gradient_accumulation_steps', type=str)
    parser.add_argument('--null_text_ratio', type=str)
    parser.add_argument('--dataloader_num_workers', type=str)
    parser.add_argument('--checkpointing_steps', type=str)
    parser.add_argument('--cache_dir', type=str)
    parser.add_argument('--max_train_steps', type=str)
