    ...
    for epoch in range(max_epoch):
        ...
        with tqdm(total=labeled_slice, desc=f'Epoch {epoch + 1}/{max_epoch}', unit='img', leave=is_leave) as pbar:
            for i,batch in enumerate(train_loader):
                ...
                #For CMC
                _,_, masks_pred_mode1_sup, masks_pred_mode2_sup = cmc_net.forward_onlyMIA(imgs_mode1[:labeled_bs], imgs_mode2[:labeled_bs])
                ...
                for j,batch_val in enumerate(val_loader):
                    ...
                    if compute_3d==True:
                        ...
                        with torch.no_grad():
                            ...
                            #For CMC
                            _,_,mask_pred_fore_m1, mask_pred_fore_m2 = cmc_net.forward_onlyMIA(imgs_fore_m1, imgs_fore_m2)
                            _,_,mask_pred_mid_m1, mask_pred_mid_m2 = cmc_net.forward_onlyMIA(imgs_mid_m1, imgs_mid_m2)
                            _,_,mask_pred_after_m1, mask_pred_after_m2 = cmc_net.forward_onlyMIA(imgs_after_m1,imgs_after_m2)
                        ...
                        with torch.no_grad():
                            ...
                            #For CMC
                            _, _,mask_pred_mode1,mask_pred_mode2 = cmc_net.forward_onlyMIA(imgs_mode1,imgs_mode2)
...
def plot_dice_loss(train_dict,val_dict,lr_curve,base_dir,img_mode1,img_mode2, will_eval):
    ...
    if will_eval:
        ...
        plot_dice2_without_val(train_dict['dice_m1'],val_dict['dice_m1'],base_dir,f'Dice_{img_mode1}',val_dict['dice_3d_m1'],val_dict['3d_interval_list'])
        plot_dice2_without_val(train_dict['dice_m2'],val_dict['dice_m2'],base_dir,f'Dice_{img_mode2}',val_dict['dice_3d_m2'],val_dict['3d_interval_list'])
